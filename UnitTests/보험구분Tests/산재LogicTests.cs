...
//    {
//        private const string 정상바코드 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
...
//";
//        private const string 정상바코드_유형2 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        private const string 비정상바코드 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        private const string 비정상바코드_2 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        private const string 비정상바코드_3 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        private const string 비정상바코드_4 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        private const string 비정상바코드_5 = @"MSH¿0.8.0.0¿01¿Ku2.0¿20171016141414
//FAC¿12345678¿테스트의원¿¿02-2105-500¿¿
//PRD¿의사¿의사¿12345
//PID¿테스트¿111111-11111111
//ORC¿2017033101004¿20101010¿¿¿3¿¿♬써스펜이알서방정 100/100 전액본인부담
...
//        [TestCase(정상바코드)]
//        [TestCase(정상바코드_유형2)]
//        public void 산재Logic_Validation_정상바코드테스트(string data)
//        {
...
//        [TestCase(비정상바코드_2)]
//        [TestCase(비정상바코드_3)]
//        public void 산재Logic_Validation_비정상바코드Tests(string data)
//        {
//            var logic = new 산재Logic();
//            var model = ParseLogic.Parse(data);
//            var retv = logic.Validation(model);
