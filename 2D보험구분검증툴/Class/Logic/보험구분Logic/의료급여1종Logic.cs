...
{
    public class 의료급여1종Logic : I보험구분검증
    {
        public string Name { get { return "의료급여1종"; } }

        public IEnumerable<오류목록Model> GetErrorModel(BarcodeModel model, int cnt)
        {
            return new List<오류목록Model> { new 오류목록Model { No = ++cnt, 유형 = "보험구분", 메세지 = "의료급여 1종 바코드는 보험구분이 2이고 의료급여종별은 1이여야 합니다." } };
        }
